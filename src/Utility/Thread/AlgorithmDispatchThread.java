 ...
 */
public class AlgorithmDispatchThread extends Thread {
  ...
  public AlgorithmDispatchThread(String algorithm, String params, Application currentApplication, String id, Boolean multiThreading) {
